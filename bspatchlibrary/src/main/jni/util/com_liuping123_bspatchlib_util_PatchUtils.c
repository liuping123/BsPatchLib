...
#include "../header/com_liuping123_bspatchlib_util_PatchUtils.h"
...
/*
 * Class:     com_liuping123_bspatchlib_util_PatchUtils_patch
 * Method:    patch
 * Signature: (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_liuping123_bspatchlib_util_PatchUtils_patch(JNIEnv *env,
